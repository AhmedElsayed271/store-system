                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">${{ $product->price }} @if($product->compare_price)<span>${{ $product->compare_price }} @endif</span></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="form-group quantity">
                                        ...
                                        <select name='quantity' class="form-control" form="form1">
                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="button cart-button">
                                            <form action="{{ route('cart.store') }}" method='post' id='form1'>
                                                @csrf
