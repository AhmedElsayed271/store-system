...
@section('content')
    ...
    <div class="inner-banner">
        <div class="container">
            <h2 class="inner-banner-title wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">Blog Details</h2>
            ...
            <div class="row gy-5">
                <div class="col-lg-8">
                    <div class="blog-details-single">
                        <div class="blog-img">
                            <img alt="image"  src="{{ asset('assets/frontend/images/blog/blog-details.png') }}" class="img-fluid wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".2s">
                        </div>
                        <ul class="blog-meta gap-2">
                            <li><a href="#"><img alt="image"  src="{{ asset('assets/frontend/images/icons/calendar.svg') }}" >Date: 25 Jan 2022</a></li>
                            <li><a href="#"><img alt="image"  src="{{ asset('assets/frontend/images/icons/tags.svg') }}" >Auction</a></li>
                            <li><a href="#"><img alt="image"  src="{{ asset('assets/frontend/images/icons/admin.svg') }}" >Posted by Admin</a></li>
                        </ul>
                        <h3 class="blog-title">A brand for a company is like reputation for a person.</h3>
                        <div class="blog-content">
                            <p class="para">Gochujang ugh viral, butcher pabst put a bird on it meditation austin craft beer banh. Distillery ramps af, goch ujang hell of VHS kitsch austin. Vegan air plant trust fund, poke sartorial ennui next lev el photo booth coloring book etsy green juice meditation austin craft beer.</p>
                            <blockquote>
                                <img alt="image"  src="{{ asset('assets/frontend/images/icons/quote-fill-green.svg') }}" class="quote-icon" >
                                <p class="para">“If the delivery provider maintains all the standards then it is safe to have get products delivered to you. It is hard to maintain but still safer to get your products ordered If you’ve been following the crypto space”</p>
                            ...
                            <div class="blog-video-area">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <img alt="image"  src="{{ asset('assets/frontend/images/blog/blogd1.png') }}" class="img-fluid" >
                                    </div>
                                    <div class="col-md-6">
                                        <div class="video-wrapper position-relative">
                                            ...
                                            <img alt="image"  src="{{ asset('assets/frontend/images/blog/blogd2.png') }}" class="img-fluid" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="blog-author gap-4 flex-md-nowrap flex-wrap">
                            <div class="author-image">
                                <img alt="image"  src="{{ asset('assets/frontend/images/blog/blog-author.png') }}" class="img-fluid" >
                            </div>
                            <div class="author-detials text-md-end text-center">
                                <h5>-- Leslie Alexander</h5>
                            ...
                            <ul class="comment-list mb-50">
                                    ...
                                    <div class="comment-box">
                                        <div class="comment-header d-flex justify-content-between align-items-center">
                                            <div class="author d-flex flex-wrap">
                                                <img alt="image"  src="{{ asset('assets/frontend/images/blog/comment1.png') }}" >
                                    ...
                                    <ul class="comment-reply">
                                        <li>
                                            <div class="comment-box">
                                                <div class="comment-header d-flex justify-content-between align-items-center">
                                                    <div class="author d-flex flex-wrap">
                                                        <img alt="image"  src="{{ asset('assets/frontend/images/blog/comment2.png') }}" >
                                ...
                                <li>
                                    <div class="comment-box">
                                        <div class="comment-header d-flex justify-content-between align-items-center">
                                            <div class="author d-flex flex-wrap">
                                                <img alt="image"  src="{{ asset('assets/frontend/images/blog/comment3.png') }}" >
